...
**生成时间**: Sat Dec 20 22:01:17 CST 2025
**报告目录**: test-reports/20251220_220100
...
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[3/9]⎯
 ...
 Test Files  9 failed (9)
      Tests  no tests
   Start at  14:01:14
   Duration  2.98s (transform 33ms, setup 0ms, collect 0ms, tests 0ms, environment 14.56s, prepare 2.78s)
```
...
### 在浏览器中查看后端覆盖率
```bash
open test-reports/20251220_220100/backend-coverage-html/index.html
```

### 在浏览器中查看前端覆盖率（如果存在）
```bash
open test-reports/20251220_220100/frontend-coverage/index.html
```

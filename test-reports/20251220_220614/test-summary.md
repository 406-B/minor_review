...
**生成时间**: Sat Dec 20 22:06:28 CST 2025
**报告目录**: test-reports/20251220_220614
...
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[3/9]⎯
 ...
 Test Files  9 failed (9)
      Tests  no tests
   Start at  14:06:25
   Duration  3.00s (transform 32ms, setup 0ms, collect 0ms, tests 0ms, environment 15.57s, prepare 2.72s)
```
...
### 在浏览器中查看后端覆盖率
```bash
open test-reports/20251220_220614/backend-coverage-html/index.html
```

### 在浏览器中查看前端覆盖率（如果存在）
```bash
open test-reports/20251220_220614/frontend-coverage/index.html
```
